...
export default function AnalyticsAdminPage() {
  ...
  return (
    <div className="ym-page">
      <div className="ym-container ym-admin ym-analytics">
        <div className="ym-analytics-header">
          <div>
            <h1 className="ym-page-title">Website analytics</h1>
            <p className="ym-admin-lead">
              Visitor counts, locations, and device breakdown. Admin access only.
            </p>
          </div>
          <div className="ym-analytics-nav">
            <Link href="/admin/loan-plans" className="ym-admin-btn ym-admin-btn--ghost">
              Loan plans
            </Link>
          </div>
        </div>
        ...
        <section className="ym-admin-panel">
          <label className="ym-admin-field" htmlFor="analytics-admin-secret">
            <span className="ym-admin-label">Admin secret</span>
            <input
              id="analytics-admin-secret"
              className="ym-admin-input"
              type="password"
              value={secret}
              onChange={(event) => setSecret(event.target.value)}
              placeholder="Same secret as loan plans admin"
            />
          </label>
          <button
            type="button"
